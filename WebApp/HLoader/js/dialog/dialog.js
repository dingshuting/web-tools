...
;(function(win,$){
    ...
    var _renderDOM = function(){
        ...
        dialogWrapper.append(
            ...
            content = $('<div class="dialog-content" style="text-align: center;"></div>')
        );
        ...
        switch (settings.type){
            ...
            case 'confirm' :
                ...
                content.append(
                    contentBd = $('<div class="dialog-content-bd" style="text-align: center;">'+ settings.contentHtml +'</div>')
                );
                content.append(
                    contentFt = $('<div class="dialog-content-ft"></div>')
                );
    ...
    $_dialog.update = function(params) {
        if(params.infoText) {
